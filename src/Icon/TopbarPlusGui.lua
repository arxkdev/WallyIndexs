...
topbarContainer.Size = UDim2.new(1, 0, 0, topbar_y_offset)
topbarContainer.Visible = true
topbarContainer.ZIndex = 1
topbarContainer.Parent = topbarPlusGui
topbarContainer.Active = false

GUI_SERVICE:GetPropertyChangedSignal('TopbarInset'):Connect(function()
    local height : Rect = GUI_SERVICE.TopbarInset.Height
    
    topbarContainer.Position = UDim2.new(0, 0, 0, height - topbar_y_offset)
end)

local iconContainer = Instance.new("Frame")
iconContainer.BackgroundTransparency = 1
iconContainer.Name = "IconContainer"
iconContainer.Position = UDim2.new(0, 72, 0, 0)
...
noticeFrame.Size = UDim2.new(0, 24, 0, 24)
