...
return {
    ...
    toggleable = {
        ...
        selected = {
            iconBackgroundColor = Color3.fromRGB(0, 0, 0),
            iconBackgroundTransparency = 0.15,
			iconImageColor = Color3.fromRGB(255, 255, 255),
			iconImageYScale = 0.681818182,
            iconTextColor = Color3.fromRGB(255, 255, 255),
            clickPlaybackSpeed = 2,
        }
    },
