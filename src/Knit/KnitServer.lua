...
KnitServer.Packages = KnitServer.Util.Parent.Parent
KnitServer.ServerPackages = KnitServer.Packages.Parent.ServerPackages
KnitServer.Shared = require(KnitServer.Packages.Parent.Shared)
KnitServer.Utility = KnitServer.Shared.Utility
